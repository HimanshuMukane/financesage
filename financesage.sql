...
INSERT INTO `events` (`blog_id`, `blog_title`, `about`, `title_2`, `img_link`, `type_id`) VALUES
...
INSERT INTO `event_info` (`blog_id`, `Date`, `time`, `location`) VALUES
...
INSERT INTO `registered` (`rid`, `usn`, `blog_id`) VALUES
(1, '1VA17CS005', 2),
(2, '1VA17CS012', 4),
(3, '1VA17CS034', 2),
(4, '1VA17CS005', 3),
...
set events.title_2=events.title_2+1
WHERE events.blog_id=new.blog_id
$$
DELIMITER ;
...
INSERT INTO `staff_coordinator` (`stid`, `name`, `phone`, `blog_id`) VALUES
...
INSERT INTO `student_coordinator` (`sid`, `st_name`, `phone`, `blog_id`) VALUES
